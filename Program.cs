...
for (int i=1; i<(n+1); i++)                                      // организовываем цикл от 1 до числа n здесь пришлось прибавить 1 так как итерация идет до числа n не включительно
{
    Console.Write(Math.Pow(i,3));                                // вывод на экран куба числа i, через метод Math.Pow (arg1,arg2) где agr1 это возволимое число и arg2 это степень
